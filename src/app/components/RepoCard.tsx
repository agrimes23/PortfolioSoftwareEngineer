...
const RepoCard: React.FC<RepoCardProps> = ({
  ...
  return (
    <div className="bg-neutralSecondary border-2 border-neutralSecondary-dark rounded-lg mt-20 mb-32 flex flex-col text-accent w-[300px] md:w-[400px] min-h-[300px]">
      <div>
      <Image
